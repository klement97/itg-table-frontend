...
const API = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiHost}`;
const AUTH = `${API}/auth`;
...
let AuthService = class AuthService {
    ...
    login(username, password) {
        return this.http.post(`${LOGIN}/`, { username, password }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(user => {
            if (user) {
        ...
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(console.log(err))));
    }
    logout() {
        const currentUser = JSON.parse(localStorage.getItem('user'));
        return this.http.post(`${LOGOUT}/`, currentUser.auth_token).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(() => {
...
let NavigationComponent = class NavigationComponent {
    constructor(breakpointObserver, dialog, store, auth, router) {
...
const loadOrderUnits = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[OrderUnit/API] Load OrderUnits', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const addOrderUnit = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[OrderUnit/API] Add OrderUnit', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const upsertOrderUnit = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[OrderUnit/API] Upsert OrderUnit', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const addOrderUnits = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[OrderUnit/API] Add OrderUnits', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const upsertOrderUnits = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[OrderUnit/API] Upsert OrderUnits', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const updateOrderUnit = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[OrderUnit/API] Update OrderUnit', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const updateOrderUnits = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[OrderUnit/API] Update OrderUnits', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const deleteOrderUnit = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[OrderUnit/API] Delete OrderUnit', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const deleteOrderUnits = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[OrderUnit/API] Delete OrderUnits', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const clearOrderUnits = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[OrderUnit/API] Clear OrderUnits');
...
const loadOrders = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Order/API] Load Orders', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const addOrder = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Order/API] Add Order', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const upsertOrder = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Order/API] Upsert Order', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const addOrders = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Order/API] Add Orders', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const upsertOrders = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Order/API] Upsert Orders', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const updateOrder = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Order/API] Update Order', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const updateOrders = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Order/API] Update Orders', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const deleteOrder = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Order/API] Delete Order', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const deleteOrders = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Order/API] Delete Orders', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const clearOrders = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Order/API] Clear Orders');
...
const loadTables = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Table/API] Load Tables', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const addTable = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Table/API] Add Table', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const upsertTable = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Table/API] Upsert Table', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const addTables = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Table/API] Add Tables', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const upsertTables = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Table/API] Upsert Tables', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const updateTable = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Table/API] Update Table', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const updateTables = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Table/API] Update Tables', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const deleteTable = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Table/API] Delete Table', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const deleteTables = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Table/API] Delete Tables', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const clearTables = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Table/API] Clear Tables');
...
const orderUnitsFeatureKey = 'orderUnits';
const adapter = Object(_ngrx_entity__WEBPACK_IMPORTED_MODULE_2__["createEntityAdapter"])();
const initialState = adapter.getInitialState({});
const orderUnitReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_unit_actions__WEBPACK_IMPORTED_MODULE_3__["addOrderUnit"], (state, action) => adapter.addOne(action.orderUnit, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_unit_actions__WEBPACK_IMPORTED_MODULE_3__["upsertOrderUnit"], (state, action) => adapter.upsertOne(action.orderUnit, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_unit_actions__WEBPACK_IMPORTED_MODULE_3__["addOrderUnits"], (state, action) => adapter.addMany(action.orderUnits, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_unit_actions__WEBPACK_IMPORTED_MODULE_3__["upsertOrderUnits"], (state, action) => adapter.upsertMany(action.orderUnits, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_unit_actions__WEBPACK_IMPORTED_MODULE_3__["updateOrderUnit"], (state, action) => adapter.updateOne(action.orderUnit, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_unit_actions__WEBPACK_IMPORTED_MODULE_3__["updateOrderUnits"], (state, action) => adapter.updateMany(action.orderUnits, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_unit_actions__WEBPACK_IMPORTED_MODULE_3__["deleteOrderUnit"], (state, action) => adapter.removeOne(action.id, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_unit_actions__WEBPACK_IMPORTED_MODULE_3__["deleteOrderUnits"], (state, action) => adapter.removeMany(action.ids, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_unit_actions__WEBPACK_IMPORTED_MODULE_3__["loadOrderUnits"], (state, action) => adapter.addAll(action.orderUnits, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_unit_actions__WEBPACK_IMPORTED_MODULE_3__["clearOrderUnits"], state => adapter.removeAll(state)));
function reducer(state, action) {
    return orderUnitReducer(state, action);
}
const { selectIds, selectEntities, selectAll, selectTotal, } = adapter.getSelectors();
const selectAllOrderUnits = selectAll;
const selectCountOrderUnits = selectTotal;
const selectEntityOrderUnits = selectEntities;
const selectIdsOrderUnit = selectIds;
...
const ordersFeatureKey = 'orders';
const adapter = Object(_ngrx_entity__WEBPACK_IMPORTED_MODULE_2__["createEntityAdapter"])();
const initialState = adapter.getInitialState({
// additional entity state properties
});
const orderReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_actions__WEBPACK_IMPORTED_MODULE_3__["addOrder"], (state, action) => adapter.addOne(action.order, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_actions__WEBPACK_IMPORTED_MODULE_3__["upsertOrder"], (state, action) => adapter.upsertOne(action.order, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_actions__WEBPACK_IMPORTED_MODULE_3__["addOrders"], (state, action) => adapter.addMany(action.orders, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_actions__WEBPACK_IMPORTED_MODULE_3__["upsertOrders"], (state, action) => adapter.upsertMany(action.orders, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_actions__WEBPACK_IMPORTED_MODULE_3__["updateOrder"], (state, action) => adapter.updateOne(action.order, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_actions__WEBPACK_IMPORTED_MODULE_3__["updateOrders"], (state, action) => adapter.updateMany(action.orders, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_actions__WEBPACK_IMPORTED_MODULE_3__["deleteOrder"], (state, action) => adapter.removeOne(action.id, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_actions__WEBPACK_IMPORTED_MODULE_3__["deleteOrders"], (state, action) => adapter.removeMany(action.ids, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_actions__WEBPACK_IMPORTED_MODULE_3__["loadOrders"], (state, action) => adapter.addAll(action.orders, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_order_actions__WEBPACK_IMPORTED_MODULE_3__["clearOrders"], state => adapter.removeAll(state)));
function reducer(state, action) {
    return orderReducer(state, action);
}
const { selectIds, selectEntities, selectAll, selectTotal, } = adapter.getSelectors();
const selectAllOrders = selectAll;
...
const tablesFeatureKey = 'tables';
const adapter = Object(_ngrx_entity__WEBPACK_IMPORTED_MODULE_2__["createEntityAdapter"])();
const initialState = adapter.getInitialState({});
const tableReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_table_actions__WEBPACK_IMPORTED_MODULE_3__["addTable"], (state, action) => adapter.addOne(action.table, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_table_actions__WEBPACK_IMPORTED_MODULE_3__["upsertTable"], (state, action) => adapter.upsertOne(action.table, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_table_actions__WEBPACK_IMPORTED_MODULE_3__["addTables"], (state, action) => adapter.addMany(action.tables, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_table_actions__WEBPACK_IMPORTED_MODULE_3__["upsertTables"], (state, action) => adapter.upsertMany(action.tables, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_table_actions__WEBPACK_IMPORTED_MODULE_3__["updateTable"], (state, action) => adapter.updateOne(action.table, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_table_actions__WEBPACK_IMPORTED_MODULE_3__["updateTables"], (state, action) => adapter.updateMany(action.tables, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_table_actions__WEBPACK_IMPORTED_MODULE_3__["deleteTable"], (state, action) => adapter.removeOne(action.id, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_table_actions__WEBPACK_IMPORTED_MODULE_3__["deleteTables"], (state, action) => adapter.removeMany(action.ids, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_table_actions__WEBPACK_IMPORTED_MODULE_3__["loadTables"], (state, action) => adapter.addAll(action.tables, state)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(src_app_order_store_actions_table_actions__WEBPACK_IMPORTED_MODULE_3__["clearTables"], state => adapter.removeAll(state)));
function reducer(state, action) {
    return tableReducer(state, action);
}
const { selectIds, selectEntities, selectAll, selectTotal, } = adapter.getSelectors();
const selectAllTables = selectAll;
const selectCountTables = selectTotal;
...
const selectOrderUnitState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createFeatureSelector"])(src_app_order_store_reducers_order_unit_reducer__WEBPACK_IMPORTED_MODULE_2__["orderUnitsFeatureKey"]);
const selectOrderUnits = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectOrderUnitState, src_app_order_store_reducers_order_unit_reducer__WEBPACK_IMPORTED_MODULE_2__["selectAllOrderUnits"]);
const selectOrderCount = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectOrderUnitState, src_app_order_store_reducers_order_unit_reducer__WEBPACK_IMPORTED_MODULE_2__["selectCountOrderUnits"]);
const selectOrderUnitIds = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectOrderUnitState, src_app_order_store_reducers_order_unit_reducer__WEBPACK_IMPORTED_MODULE_2__["selectIdsOrderUnit"]);
...
const selectOrderState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createFeatureSelector"])(src_app_order_store_reducers_order_reducer__WEBPACK_IMPORTED_MODULE_2__["ordersFeatureKey"]);
const selectOrderList = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectOrderState, src_app_order_store_reducers_order_reducer__WEBPACK_IMPORTED_MODULE_2__["selectAllOrders"]);
...
const selectTablesState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createFeatureSelector"])(src_app_order_store_reducers_table_reducer__WEBPACK_IMPORTED_MODULE_2__["tablesFeatureKey"]);
const selectTables = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectTablesState, src_app_order_store_reducers_table_reducer__WEBPACK_IMPORTED_MODULE_2__["selectAllTables"]);
...
const API = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiHost}`;
...
let OrderService = class OrderService {
    ...
    createOrder(order) {
        return this.http.post(`${ORDERS_URL}/`, order).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(() => {
            this.store.dispatch(Object(src_app_order_store_actions_order_unit_actions__WEBPACK_IMPORTED_MODULE_8__["clearOrderUnits"])());
            this.router.navigate(['order/tables']);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(console.log(err))));
    }
    getOrderList(page) {
        return this.http.get(`${ORDERS_URL}/?page=${page}`);
    }
    sendOrderMail(to, order) {
...
let CartComponent = class CartComponent {
    ...
    removeUnit(event, id) {
        event.stopPropagation();
        this.store.dispatch(Object(src_app_order_store_actions_order_unit_actions__WEBPACK_IMPORTED_MODULE_5__["deleteOrderUnit"])({ id }));
    }
    checkout() {
        this.router.navigate(['/order/form']);
    }
    calculateTotalPrice() {
        this.cartSubscription$ = this.store.select(src_app_order_store_selectors_order_unit_selectors__WEBPACK_IMPORTED_MODULE_4__["selectOrderUnits"]).subscribe(orders => {
            if (orders) {
                this.totalPrice = 0;
...
let OrderDetailDialogComponent = class OrderDetailDialogComponent {
    constructor(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
...
OrderDetailDialogComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] }
];
...
TableDetailComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
...
let OrderFormComponent = class OrderFormComponent {
    constructor(fb, store, orderService, dialog, router) {
        this.fb = fb;
        this.store = store;
    ...
    onSubmit() {
        this.orderService.createOrder(this.preparedData()).subscribe(response => this.router.navigate(['/order/list'])
    ...
    preparedData() {
        ...
        this.cart$.subscribe(units => {
            for (let unit of units) {
                let orderUnit = new src_app_order_store_models_order_unit_model__WEBPACK_IMPORTED_MODULE_6__["OrderUnit"]();
...
let OrderListComponent = class OrderListComponent {
    constructor(orderService, store, dialog) {
        this.orderService = orderService;
        this.store = store;
        this.dialog = dialog;
        this.count = 0;
    ...
    ngOnInit() {
        this.orderService.getOrderList(1).subscribe(response => {
            ...
            this.store.dispatch(src_app_order_store_actions_order_actions__WEBPACK_IMPORTED_MODULE_5__["loadOrders"]({ orders: response['results'] }));
            Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(console.log('error: ', err)));
        });
    }
    updateOrder(order) {
...
let OrderPageComponent = class OrderPageComponent {
    constructor(orderService, dialog, store) {
        this.orderService = orderService;
        this.dialog = dialog;
        this.store = store;
        this.fake_id = 1;
    ...
    ngOnInit() {
        this.subs$ = this.store.select(src_app_order_store_selectors_table_selectors__WEBPACK_IMPORTED_MODULE_10__["selectTables"]).subscribe(tables => {
            if (!tables.length) {
                this.getAllTables();
            }
        });
    ...
    getAllTables() {
        return this.orderService.getTables()
            .subscribe(response => {
            this.store.dispatch(src_app_order_store_actions_table_actions__WEBPACK_IMPORTED_MODULE_8__["addTables"]({ tables: response['results'] }));
        });
    }
    openPhoto(path) {
    ...
    openForm(table) {
        this.dialog.open(src_app_order_dialogs_table_form_table_form_component__WEBPACK_IMPORTED_MODULE_5__["TableFormComponent"], {
            ...
            if (result) {
                const orderUnit = Object.assign({}, result['order']);
                orderUnit.id = this.fake_id++;
                orderUnit.table = table;
                this.store.dispatch(Object(src_app_order_store_actions_order_unit_actions__WEBPACK_IMPORTED_MODULE_7__["addOrderUnit"])({ orderUnit }));
            }
        });
    }
};
